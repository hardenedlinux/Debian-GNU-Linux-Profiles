...
Now, after introduce "resource centric", if a prog* was collected in the corpus, it can be used by the subsequent syscall as a special resource. Prog1 may be generated in this way:   
